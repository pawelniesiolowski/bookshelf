...
/**
 * @ORM\Entity(repositoryClass="App\BookAction\Infrastructure\Repository\BookChangeEventRepository")
 */
class BookChangeEvent
{
    ...
    public function toView(): BookChangeEventView
    {
        return new BookChangeEventView(
            $this->name,
            $this->num,
            $this->bookTitle,
            $this->bookAuthor,
